        ...
        <div class="bg-[#e4d5ff] max-w-3xl mx-auto px-5 lg:px-20 py-8 my-20 rounded-lg shadow-lg"   >
            <div class="flex flex-col  ">
                ...
                <div class="relative bg-white p-10 rounded-lg shadow-lg w-full">
                    ...
                    <div class="flex relative justify-center top-3 w-full">
                        <button type="button" class="bg-[#b26cff] absolute  rounded-full text-white px-4 py-3 cursor-pointer" @click="showForm = !showForm">+ New Task</button>
                    </div>
                </div>
                    <div x-show="showForm">
                        <form action="includes/index.inc.php" method='post' class='flex w-full items-center justify-center mt-10 gap-3'>
                            ...
                            <button type="button" class="ml-2 bg-red-500 text-white  rounded-full cursor-pointer" @click="showForm = false">
